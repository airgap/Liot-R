  ...
  <head>
    ...
    <script>
      ...
      function populate() {
        var distributors = [];
        for(var i = 0; i < 100; i ++)
          distributors.push({name:'OUTTHERM_'+i,
            device_info:
      ...
      function gotoStart() {
        location.href = "/distributors.php?after=0";
      }
      function gotoPrevious() {
        location.href = "/distributors.php?after=" + Math.max(0,after-30);
      }
      function gotoNext() {
        location.href = "/distributors.php?after=" + Math.max(0,after+30);
      }
      function gotoLast() {
        location.href = "/distributors.php?after=-30";
      }
