import { insertDistributors } from '../insertDistributors';
 ...
 * @function
 */
export class AddDistributors {
	addDistributors = async (params, r) => {
